  ...
  return (
    <div className="max-w-screen-2xl mx-auto pt-20 px-5">
      ...
      <div className="bg-white border border-gray-200 p-5 overflow-x-auto">
        ...
        <p className="mb-2">Tax: ${(singleOrder.subtotal / 5).toFixed(2)}</p>
        <p className="mb-2">
          Total: $
        ...
        <table className="singleOrder-table min-w-full bg-white border border-gray-200">
          <thead>
            <tr>
              ...
              <th className="py-3 px-4 border-b">Storage</th> {/* Thêm Storage */}
              <th className="py-3 px-4 border-b">Color</th> {/* Thêm Color */}
            ...
            {singleOrder.products.map((product) => (
              <tr key={nanoid()}>
                ...
                <td className="py-3 px-4 border-b text-center">
                  {product?.storage} {/* Hiển thị Storage */}
                </td>
                <td className="py-3 px-4 border-b text-center">
                  {product?.color} {/* Hiển thị Color */}
                </td>
                <td className="py-3 px-4 border-b text-center">
                  {product?.quantity}
                </td>
